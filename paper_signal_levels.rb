...
OptionParser.new do |op|
  ...
  op.on('-i', '--in-rms=RMS', Float, "RMS value of input signal [#{OPTS.adc_rms}]") do |o|
    OPTS.adc_rms = o
  end
...
pf_rms, fft_rms, reim_rms, eq_rms, quant_rms = paper_levels(OPTS.adc_rms, NSTAGES, (1<<OPTS.nshift)-1, OPTS.eq)

printf "ADC   output RMS %f\n", OPTS.adc_rms
